...
shop[2].name = "Ui";
shop[2].item[0] = {type:SHOP_MESSAGE, msg1:"Why don't you rest", msg2:"and eat something?"};
shop[2].item[1] = {type:SHOP_ROOM, value:10};
shop[2].background = 6;

shop[3].name = "The last golden Chocopan";
shop[3].item[0] = {type:SHOP_MESSAGE, msg1:"The last chocopan", msg2:"ever is for sale."};
shop[3].item[1] = {type:SHOP_MESSAGE, msg1:"Sakuragaoka is now", msg2:"a battleground."};
shop[3].background = 1;

shop[4].name = "Sumire";
shop[4].item[0] = {type:SHOP_WEAPON, value:4};
shop[4].background = 5;

shop[5].name = "Ui";
shop[5].item[0] = {type:SHOP_MESSAGE, msg1:"Why don't you rest", msg2:"and eat something?"};
shop[5].item[1] = {type:SHOP_ROOM, value:10};
shop[5].background = 6;
...
function shop_set_spell(slot, spell_id) {
  ...
  shop_set_buy(slot, "Songbook: " + info.spells[spell_id].name, info.spells[spell_id].gold, disable_reason); 
}
...
function shop_set_room(slot, room_cost) {
  ...
  shop_set_buy(slot, "Eggs and juice", room_cost, disable_reason);
}
...
function shop_set_buy(slot, name, cost, disable_reason) {
  ...
  if (disable_reason != "") {
    ...
    dialog.option[slot].msg2 = "for " + cost + " yen";
  }
...
function shop_buy_room(cost) {
  ...
  avatar.gold -= cost;
  sounds_play(SFX_COIN);
  dialog.message = "You have eaten and rested";
