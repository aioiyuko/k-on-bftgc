...
function power_ice() {
  ...
  // against undead, burn does 2x crit
  if (combat.enemy.category == ENEMY_CATEGORY_AUTOMATON || combat.enemy.category == ENEMY_CATEGORY_DEMON) {
    attack_damage += atk_max + atk_max;
  }
  // against most creatures burn does 1x crit
  else if (combat.enemy.category != ENEMY_CATEGORY_SHADOW) {
    attack_damage += atk_max;
  }
  // against demons, burn does regular weapon damage.
...
function power_light() {
  ...
  // against undead, burn does 2x crit
  if (combat.enemy.category == ENEMY_CATEGORY_SHADOW) {
    attack_damage += atk_max + atk_max;
  }
  // against most creatures burn does 1x crit
  else if (combat.enemy.category != ENEMY_CATEGORY_AUTOMATON) {
    attack_damage += atk_max;
  }
  // against demons, burn does regular weapon damage.
